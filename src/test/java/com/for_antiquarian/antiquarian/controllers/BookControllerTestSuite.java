...
//
//        //Given & When & Then
//        mockMvc.perform(formLogin("/v1/book/changeSignature/1?signature=S2").user("admin").password("admin")
//                        .acceptMediaType(MediaType.APPLICATION_JSON))
//                .andExpect(status().is(200));
//    }
//
...
//
//        //Given & When & Then
//        mockMvc.perform(formLogin("/v1/book/changeStatus/1?bookStatus=LOST").user("admin").password("admin")
//                        .acceptMediaType(MediaType.APPLICATION_JSON))
//                .andExpect(status().is(200));
//    }
//
